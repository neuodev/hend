  ...
  return (
    <div className="py-10 flex items-center justify-center flex-col border-b border-gray-200">
      ...
      <div className="max-w-screen-lg grid grid-cols-12 grid-row-6 items-center justify-between">
        <div className="col-span-12 md:col-start-7 md:col-end-13 row-span-full flex items-center justify-center h-full">
          <div
        ...
        <p className="leading-loose text-gray-700 text-center font-normal text-lg col-span-12 md:col-start-1 md:col-end-7 p-8 md:row-span-full">
